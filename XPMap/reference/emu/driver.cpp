...
int main(int argc, char** argv) {
  ...
  system("cp Files/XPChart/mapdump_XAUUSD-ECNc_S1.csv Files/XPChart/dump_A.csv");
  feed(n, false); call(n, 0);
  system("cp Files/XPChart/mapdump_XAUUSD-ECNc_S1.csv Files/XPChart/dump_B.csv");
